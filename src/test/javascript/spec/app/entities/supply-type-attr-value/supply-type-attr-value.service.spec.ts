...
describe('Service Tests', () => {
    ...
    describe('SupplyTypeAttrValue Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SupplyTypeAttrValueService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/supply-type-attr-values';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SupplyTypeAttrValue', () => {
